    ...
    <div className="bg-black text-white py-20">
      <div className="max-w-[1100px] mx-auto px-4 border-b py-10 border-gray-500 flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="flex flex-col  justify-center lg:gap-2 ">
          ...
          <h2 className="text-sm lg:text-xl text-gray-500 ">
            {t.hero.hello}
          </h2>
...
function Photo({ engineering }: { engineering: string }) {
  return (
    <div className="relative flex justify-center items-center mt-8">
      ...
      <div className="relative w-40 h-40 md:w-60 md:h-60 rounded-full p-[3px] bg-gradient-to-b from-red-500 via-red-500/50 to-transparent shadow-lg shadow-red-500/30">
      ...
      <div className="absolute top-2 -right-15 md:top-6  flex items-center gap-1.5 bg-gray-900 border border-gray-700 rounded-full px-3 py-1.5 shadow-md">
        <span>🎨</span>
        <span className="text-white text-xs font-medium">Design</span>
      </div>

      {/* Badge "Génie Logiciel" - bas gauche */}
      <div className="absolute bottom-4 -left-20 md:bottom-8  flex items-center gap-1.5 bg-gray-900 border border-gray-700 rounded-full px-3 py-1.5 shadow-md">
        <span>💻</span>
