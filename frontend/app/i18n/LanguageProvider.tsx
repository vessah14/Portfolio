...
const translations = {
  fr: {
    ...
    projects: { title: "Mes réalisations", description: "Une sélection de projets en développement, design UI/UX et design graphique.", all: "Tous", noImage: "Aucune image disponible", noProjects: "Aucun projet enregistré pour le moment.", noSkills: "Aucune compétence enregistrée pour le moment.", viewImage: "Voir l'image de", viewSite: "Voir le site", viewDetail: "Voir le détail", viewDetails: "Voir les détails", close: "Fermer la vue agrandie", other: "Autre" },
  ...
  en: {
    ...
    projects: { title: "My work", description: "A selection of development, UI/UX design and graphic design projects.", all: "All", noImage: "No image available", noProjects: "No project is registered yet.", noSkills: "No skill is registered yet.", viewImage: "View image of", viewSite: "View website", viewDetail: "View detail", viewDetails: "View details", close: "Close enlarged view", other: "Other" },
